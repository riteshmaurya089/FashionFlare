...
export const getRequestforAdminSide = (params, category) => (dispatch) => {
  ...
  axios
    .get(`https://fashionflore.onrender.com/product/${category}`, { params })
    .then((res) => {
...
export const patchRequestforAdminSide = (id, category, obj) => (dispatch) => {
  ...
  return axios
    .patch(`https://fashionflore.onrender.com/product/${category}/${id}`, obj)
    .then((res) => {
...
export const deleteRequest = (id, category) => (dispatch) => {
  dispatch(getRequestAdmin());
  return axios
    .delete(`https://fashionflore.onrender.com/product/${category}/${id}`)
    .then((response) => {
...
export const postRequestAdminSide = (category, data) => (dispatch) => {
  dispatch(getRequestAdmin);
  axios
    .post(`https://fashionflore.onrender.com/product/${category}`, data)
    .then((res) => {
      // console.log(res);
      dispatch(patchRequestSuccessAdminSide());
    })
...
export const addTocartData = (cartData) => (dispatch) => {
  dispatch(getRequestAdmin);
  axios
    .post(`https://fashionflore.onrender.com/cart/`, cartData)
    .then((res) => {
      dispatch(patchRequestSuccessAdminSide());
    })
    .catch((err) => {
